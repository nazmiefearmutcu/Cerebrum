...
from benchmarks.tasks.relational import make_episode, run_grail_episode
...
def run_sweep(Ks=(5, 10, 20), seeds=(0, 1, 2, 3, 4), n_nodes=16, n_relations=3, vocab=5):
...
if __name__ == "__main__":
    ...
    for K in sorted(res['grail']):
        print(f"{K:>4}  {fmt_ci(res['grail_raw'][K]):>18}  {fmt_ci(res['flat_raw'][K]):>18}  {fmt_ci(res['mlp_raw'][K]):>18}")
