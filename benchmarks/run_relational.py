...
from benchmarks.tasks.relational import make_episode, run_grail_episode, RelationalGraph, TreeRelationalGraph
...
if __name__ == "__main__":
    ...
    for K in sorted(res_rand['grail']):
        print(f"{K:>4}  {fmt_ci(res_rand['grail_raw'][K]):>18}  {fmt_ci(res_rand['flat_raw'][K]):>18}  {fmt_ci(res_rand['mlp_raw'][K]):>18}")
    ...
    print(f"{'K':>4}  {'GRAIL-grid':>18}  {'flat-prior':>18}  {'backprop-MLP':>18}")
    for K in sorted(res_tree['grail']):
        print(f"{K:>4}  {fmt_ci(res_tree['grail_raw'][K]):>18}  {fmt_ci(res_tree['flat_raw'][K]):>18}  {fmt_ci(res_tree['mlp_raw'][K]):>18}")
    print("=" * 80)
